export const en = {
  ...
  menubar: {
    ...
    cycleView: 'Cycle Edit/Split/Preview',
    uiZoomIn: 'UI: Zoom In',
    uiZoomOut: 'UI: Zoom Out',
    uiZoomReset: 'UI: Reset Zoom',
    editorZoomIn: 'Editor: Zoom In',
    editorZoomOut: 'Editor: Zoom Out',
    editorZoomReset: 'Editor: Reset Zoom',
    previewZoomIn: 'Preview: Zoom In',
    previewZoomOut: 'Preview: Zoom Out',
    previewZoomReset: 'Preview: Reset Zoom',
    palette: 'Command Palette',
    globalSearch: 'Search in Folder…',
    settings: 'Settings…',
    mdHelp: 'Markdown Cheatsheet',
    about: 'About SoloMD',
    minimize: 'Minimize',
    maximize: 'Maximize',
    restore: 'Restore',
  ...
  toolbar: {
    ...
    exportPdf: 'Export to PDF (image)…',
    exportPdfHint: 'Rasterised — text not selectable, larger file. No dialog.',
    exportPdfPrint: 'Export to PDF (text)…',
    exportPdfPrintHint: 'Real selectable text via the system print dialog. Recommended.',
    ...
    aiRewriteTooltip: 'AI Rewrite — rewrite / shorten / translate / explain selection',
    newFile: 'New file',
    ...
    readingMode: 'Reading mode — full-bleed serif, no chrome',
    livePreviewOn: 'Live preview ON — click for raw source',
    livePreviewOff: 'Raw source — click for live preview',
    listContinueOn: 'List format inherited on Enter: ON — click to turn off',
    listContinueOff: 'List format inherited on Enter: OFF — Enter starts a plain line',
    autoNumberOn: 'Auto numbering ON — ordered items count up (1.1 Enter → 1.2)',
    autoNumberOff: 'Auto numbering OFF — ordered lists no longer continue on Enter',
    ...
    cjkProofreadTooltip: 'CJK proofread — flag Chinese typography typos',
    fileTreeTooltip: 'Toggle file tree',
    rightSidebarTooltip: 'Toggle right sidebar — Outline / Backlinks / Tags / History / Agent panel',
    outlineTooltip: 'Toggle outline',
    searchTooltip: 'Search in folder',
    phoneMore: 'More tools',
    phoneLess: 'Fewer tools',
    paletteTooltip: 'Command palette',
    helpTooltip: 'Markdown cheatsheet',
  ...
  outline: {
    empty: 'No headings',
    hint: 'Enter ↵ go to · Esc cancel',
    expandSection: 'Expand section',
    collapseSection: 'Collapse section',
    pressToJump: 'Press {key} to go there',
    jumpByLetter: 'letter → jump · g+digits → line',
    jumpByNumber: 'number → jump · g+digits → line',
    jumpLineOnly: 'g+digits → line',
  },
  folderPicker: {
    ...
    cancel: 'Cancel',
    use: 'Use this folder',
    permNeeded: 'SoloMD needs “All files access” to browse folders on this device.',
  ...
  explorer: {
    ...
    truncatedHint: 'This folder has more than 10,000 entries; showing the first batch. Move groups into subfolders to see them all.',
    ...
    moveToNone: 'No folder matches.',
    vaultRoot: 'Vault root',
    moved: 'Moved {name} to {dest}',
    moveUndone: 'Moved {name} back',
    moveFailed: 'Could not move {name}: {error}',
    moveExists: 'There is already something called {name} in {dest}.',
    newFile: 'New file',
  ...
  settings: {
    ...
    catKeys: 'Shortcuts',
    keysInterceptedTitle: "Some shortcuts are being taken by other software",
    ...
    keysWriterUndo: "Switch back",
    keysWriterApplied: "{bold} is now bold. The file tree is on {tree}.",
    keysInterceptedBy: "Usually taken by {source} before SoloMD sees it",
    keysHint: 'Click Change, then press the chord you want. Esc cancels. Bindings apply immediately.',
    keysCatFile: 'File',
    keysCatEdit: 'Edit',
    keysCatView: 'View',
    keysCatNavigate: 'Navigate',
    keysCatTools: 'Tools',
    keysChange: 'Change',
    keysCancel: 'Cancel',
    keysUnbind: 'Unbind',
    keysReset: 'Reset',
    keysResetAll: 'Restore all defaults',
    keysRecording: 'Press a chord…',
    keysUnbound: 'not bound',
    keysConflict: '{combo} is already used by "{action}". Pick another chord.',
    theme: 'Theme',
    ...
    printTheme: 'Print style',
    printThemeLight: 'Always light',
    ...
    autoGitHelp: 'Each {key} creates a snapshot in a local .git inside your workspace. The History panel on the right lists every version per file. All local — nothing leaves your machine.',
    ...
    spellcheckLang: 'Dictionary',
    spellcheckAddDict: 'Open dictionary folder',
    spellcheckLangHint: 'Only en_US ships with SoloMD. Drop a Hunspell <code>.aff</code> + <code>.dic</code> pair (e.g. from the LibreOffice dictionaries) into that folder and it appears here.',
    ...
    customCssReloadFailed: 'Could not reload custom CSS theme',
    clear: 'Clear',
  ...
  inbox: {
    heading: 'Inbox',
    pill: 'Inbox',
    pillTooltip: 'This note is in your inbox. Click or press {key} to remove.',
  ...
  pomodoro: {
    ...
    openMenu: 'Focus session menu ({key} to start last preset)',
    ...
    shortcutHint: '{key} · start last preset',
    ...
    showControlsHint: 'When off, the chevron beside the focus-mode button is hidden. {key} still works.',
  ...
  githubSync: {
    ...
    pillDirty: 'Uncommitted changes — save with {key}',
  ...
  tableEditor: {
    ...
    notInTable: 'The cursor is not inside a table.',
    row: 'Row',
    column: 'Column',
    align: 'Align',
    ...
    rowUp: 'Move row up',
    rowDown: 'Move row down',
    rowDelete: 'Delete row',
    colLeft: 'Insert column left',
    colRight: 'Insert column right',
    colMoveLeft: 'Move column left',
    colMoveRight: 'Move column right',
