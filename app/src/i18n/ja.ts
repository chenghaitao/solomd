...
export const ja: I18n = {
  menubar: {
    ...
    selectAll: 'すべて選択',
    toggleTheme: 'テーマ切替',
    toggleFileTree: 'ファイルツリー切替',
    toggleOutline: 'アウトライン切替',
    cycleView: '編集/分割/プレビューを切替',
    uiZoomIn: 'UI: 拡大',
    uiZoomOut: 'UI: 縮小',
    uiZoomReset: 'UI: ズームをリセット',
    editorZoomIn: 'エディタ: 拡大',
    editorZoomOut: 'エディタ: 縮小',
    editorZoomReset: 'エディタ: ズームをリセット',
    previewZoomIn: 'プレビュー: 拡大',
    previewZoomOut: 'プレビュー: 縮小',
    previewZoomReset: 'プレビュー: ズームをリセット',
    palette: 'コマンドパレット',
  ...
  toolbar: {
    ...
    exportPdf: 'PDF に書き出し（画像）…',
    exportPdfHint: 'ページを画像化 — テキストは選択不可、ファイルは大きめ。ダイアログなし。',
    exportPdfPrint: 'PDF に書き出し（テキスト）…',
    exportPdfPrintHint: 'システムの印刷経由で、選択・検索できる本物のテキスト。推奨。',
    ...
    aiRewriteTooltip: 'AI 書き換え — 選択を書き換え / 短縮 / 翻訳 / 解説',
    newFile: '新規ファイル',
    openFileTooltip: 'ファイルを開く',
    saveAsTooltip: '名前を付けて保存',
    ...
    splitMode: '分割',
    previewMode: 'プレビュー',
    outlineToggle: 'アウトライン切替',
    fileTreeToggle: 'ファイルツリー切替',
    searchTitle: 'フォルダ内検索',
    ...
    previewOnly: 'プレビューのみ',
    readingMode: '読書モード — 全画面セリフ、装飾なし',
    livePreviewOn: 'ライブプレビュー ON — クリックでソース表示',
    livePreviewOff: 'ソース表示 — クリックでライブプレビュー',
    listContinueOn: 'Enter でリスト書式を引き継ぐ：オン — クリックでオフ',
    listContinueOff: 'Enter でリスト書式を引き継ぐ：オフ — Enter は通常の改行',
    autoNumberOn: '自動採番：オン — 番号付きリストを続けて採番（1.1 Enter → 1.2）',
    autoNumberOff: '自動採番：オフ — 番号付きリストを続けない',
    ...
    cjkProofreadTooltip: 'CJK 校正 — 中国語タイポを検出',
    fileTreeTooltip: 'ファイルツリー切替',
    rightSidebarTooltip: '右サイドバー切替 — アウトライン / バックリンク / タグ / 履歴 / Agent パネル',
    outlineTooltip: 'アウトライン切替',
    searchTooltip: 'フォルダ内検索',
    phoneMore: 'その他のツール',
    phoneLess: 'ツールを閉じる',
    paletteTooltip: 'コマンドパレット',
    helpTooltip: 'Markdown チートシート',
    settingsTooltip: '設定',
    lightMode: 'ライトモード',
    darkMode: 'ダークモード',
    outline: 'アウトライン',
  ...
  outline: {
    empty: '見出しがありません',
    hint: 'Enter ↵ 移動 · Esc キャンセル',
    expandSection: 'セクションを展開',
    collapseSection: 'セクションを折りたたむ',
    pressToJump: '{key} を押すと移動',
    jumpByLetter: '文字 → ジャンプ · g+数字 → 行',
    jumpByNumber: '数字 → ジャンプ · g+数字 → 行',
    jumpLineOnly: 'g+数字 → 行',
  },
  folderPicker: {
    title: 'フォルダを選択',
    ...
    cancel: 'キャンセル',
    use: 'このフォルダを使う',
    permNeeded: '端末内のフォルダを参照するには「すべてのファイルへのアクセス」権限が必要です。',
    permGrant: '権限を許可',
  },
  plainFind: {
    prev: '前へ (Shift+Enter)',
  ...
  explorer: {
    ...
    loading: '読み込み中…',
    truncated: '+ さらに 10,000 件以上 —— フォルダが大きすぎます',
    truncatedHint: 'このフォルダには 10,000 件を超える項目があります。ここでは最初の分だけ表示しています。サブフォルダに分ければすべて表示できます。',
    ...
    moveToNone: '一致するフォルダーがありません。',
    vaultRoot: 'ルートフォルダー',
    moved: '{name} を {dest} に移動しました',
    moveUndone: '{name} を元に戻しました',
    moveFailed: '{name} を移動できませんでした: {error}',
    moveExists: '{dest} には既に「{name}」があります。',
    newFile: '新規ファイル',
    newFolder: '新規フォルダ',
    rename: '名前変更',
    delete: '削除',
  ...
  settings: {
    ...
    catAdvanced: '詳細',
    catKeys: 'ショートカット',
    keysInterceptedTitle: "他のソフトに奪われているショートカットがあります",
    ...
    keysWriterUndo: "元に戻す",
    keysWriterApplied: "{bold} は太字になりました。ファイルツリーは {tree} です。",
    keysInterceptedBy: "通常 {source} が SoloMD より先に受け取ります",
    ...
    keysUnbind: '解除',
    keysReset: '戻す',
    keysResetAll: 'すべて既定に戻す',
    keysRecording: 'キーを押してください…',
    keysUnbound: '未割り当て',
    keysConflict: '{combo} は「{action}」で使用中です。別のキーを選んでください。',
    theme: 'テーマ',
    ...
    smartQuotes: 'スマート引用符',
    smartQuotesHint: 'プレビューとすべてのエクスポートで直線引用符をカーリー引用符(\' → ’、" → “ ”)に置き換えます。オフ = 入力どおりに表示。一部のフォントはカーリー引用符を全角で描画し、アポストロフィの後に余分な空白があるように見えます。',
    ...
    autoGitHelp: '{key} のたびにワークスペース内ローカル .git にスナップショットを作成。右側の履歴パネルで各ファイルのバージョンを確認できます。すべてローカル — 端末から外には出ません。',
    ...
    spellcheckLang: '辞書',
    spellcheckAddDict: '辞書フォルダを開く',
    spellcheckLangHint: '同梱は en_US のみです。Hunspell の <code>.aff</code> と <code>.dic</code> の組（LibreOffice の辞書など）をそのフォルダに入れると、ここに表示されます。',
  ...
  relationships: {
    ...
    gone: 'このビューは利用できません。削除されたか、フォルダが閉じられた可能性があります。',
...
,
  ...
  inbox: {
    heading: 'Inbox',
    pill: 'Inbox',
    pillTooltip: 'このノートは inbox に入っています。クリックまたは {key} で外せます。',
  ...
  pomodoro: {
    heading: 'フォーカスセッション',
    openMenu: 'フォーカスセッションメニュー ({key} で前回のプリセット開始)',
    ...
    showControlsHint: 'オフの場合、フォーカスモードボタンの隣のシェブロンが非表示。{key} は引き続き有効。',
  ...
  githubSync: {
    ...
    giteaCloneUrlTitle: 'またはクローン URL を貼り付け',
