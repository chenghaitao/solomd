...
export const zh: I18n = {
  ...
  toolbar: {
    ...
    listContinueOn: '回车继承列表格式：开 — 点击关闭',
    listContinueOff: '回车继承列表格式：关 — 回车就是普通换行',
    autoNumberOn: '自动编号：开 — 有序列表自动续号（1.1 回车 → 1.2）',
    autoNumberOff: '自动编号：关 — 有序列表不再自动续号',
  ...
  outline: {
    empty: '没有标题',
    hint: 'Enter ↵ 跳转 · Esc 取消',
    expandSection: '展开章节',
    collapseSection: '折叠章节',
    pressToJump: '按 {key} 跳转',
    jumpByLetter: '字母 → 跳转 · g+数字 → 行号',
    jumpByNumber: '数字 → 跳转 · g+数字 → 行号',
    jumpLineOnly: 'g+数字 → 行号',
  },
  folderPicker: {
    title: '选择文件夹',
    up: '上一级',
    ...
    cancel: '取消',
    use: '使用这个文件夹',
    permNeeded: '需要「所有文件访问」权限才能浏览手机里的文件夹。',
    permGrant: '去开启权限',
  },
  plainFind: {
  ...
  explorer: {
    ...
    truncatedHint: '这个文件夹超过 10,000 项，这里只显示第一批。把它们分到子文件夹里就能看到全部。',
    ...
    moveUndone: '已把 {name} 移回原处',
    moveFailed: '移动 {name} 失败：{error}',
    moveExists: '{dest} 里已经有一个叫 {name} 的项目了。',
    newFile: '新建文件',
    newFolder: '新建文件夹',
    rename: '重命名',
    delete: '删除',
  ...
  settings: {
    ...
    catAdvanced: '高级',
    catKeys: '快捷键',
    keysInterceptedTitle: "有快捷键被别的软件抢走了",
    ...
    keysWriterUndo: "换回去",
    keysWriterApplied: "{bold} 现在是加粗,文件树在 {tree}。",
    keysInterceptedBy: "通常会被 {source} 先截走",
  ...
  inbox: {
    heading: '收件箱',
    pill: '收件箱',
    pillTooltip: '此笔记位于收件箱中。点击或按 {key} 移出。',
    markedInbox: '已标记为收件箱',
  ...
  githubSync: {
    ...
    giteaCloneUrlTitle: '或粘贴 clone 链接',
