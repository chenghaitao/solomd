...
export const tr: I18n = {
  ...
  toolbar: {
    ...
    listContinueOn: 'Enter ile liste biçimini sürdür: AÇIK — kapatmak için tıklayın',
    listContinueOff: 'Enter ile liste biçimini sürdür: KAPALI — Enter normal satır başlatır',
    autoNumberOn: 'Otomatik numaralandırma AÇIK — numaralı öğeler saymaya devam eder (1.1 Enter → 1.2)',
    autoNumberOff: 'Otomatik numaralandırma KAPALI — numaralı listeler sürdürülmez',
  ...
  outline: {
    empty: 'Başlık yok',
    hint: 'Enter ↵ git · Esc iptal',
    expandSection: 'Bölümü genişlet',
    collapseSection: 'Bölümü daralt',
    pressToJump: 'Gitmek için {key} tuşuna basın',
    jumpByLetter: 'harf → git · g+rakam → satır',
    jumpByNumber: 'rakam → git · g+rakam → satır',
    jumpLineOnly: 'g+rakam → satır',
  },
  folderPicker: {
    title: 'Klasör seç',
    up: 'Yukarı',
    loading: 'Yükleniyor…',
    empty: 'Burada alt klasör yok.',
    cancel: 'İptal',
    use: 'Bu klasörü kullan',
    permNeeded: 'SoloMD’nin bu cihazdaki klasörlere göz atması için “tüm dosyalara erişim” izni gerekir.',
    permGrant: 'İzin ver',
  },
  plainFind: {
  ...
  explorer: {
    ...
    loading: 'Yükleniyor…',
    truncated: '+ 10.000+ daha —— klasör çok büyük',
    truncatedHint: 'Bu klasörde 10.000’den fazla öğe var; yalnızca ilk parti gösteriliyor. Hepsini görmek için alt klasörlere ayırın.',
    ...
    moveToNone: 'Eşleşen klasör yok.',
    vaultRoot: 'Kök klasör',
    moved: '{name} {dest} konumuna taşındı',
    moveUndone: '{name} geri alındı',
    moveFailed: '{name} taşınamadı: {error}',
    moveExists: '{dest} içinde zaten “{name}” var.',
    newFile: 'Yeni dosya',
  ...
  settings: {
    ...
    catKeys: 'Kısayollar',
    keysInterceptedTitle: "Bazı kısayolları başka yazılımlar alıyor",
    ...
    keysWriterUndo: "Geri al",
    keysWriterApplied: "{bold} artık kalın. Dosya ağacı {tree} üzerinde.",
    keysInterceptedBy: "Genellikle SoloMD görmeden {source} tarafından alınır",
  ...
  tabMenu: {
    ...
    showOutline: 'Ana hatları göster',
    hideOutline: 'Ana hatları gizle',
    newTab: 'Yeni sekme',
  },
  unsaved: {
